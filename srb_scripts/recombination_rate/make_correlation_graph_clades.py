...
f_strains = ['chr','CAGAGAGG-AAGGAGTA','CAGAGAGG-GTAAGGAG','CTCTCTAC-TATCCTCT','AAGAGGCA-CTCTCTAT','AAGAGGCA-TATCCTCT','AAGAGGCA-CTAAGCCT','GCTACGCT-ACTGCATA','PB39','PB32','PB40','PB88','PB16','PB79','PB87','AAGAGGCA-TAGATCGC','AAGAGGCA-GTAAGGAG','PB64']
topAB_strains = ['chr', 'TAAGGCGA-CTCTCTAT','TAAGGCGA-ACTGCATA','PB83','AGGCAGAA-CTCTCTAT','AGGCAGAA-TAGATCGC','PB53','GTAGAGGA-CTCTCTAT','TCCTGAGC-ACTGCATA','PB58','TCCTGAGC-AGAGTAGA','PB33','PB_4','PB84']
basalAB_strains = ['chr', 'CGTACTAG-TATCCTCT','CGTACTAG-GTAAGGAG','PB50','AGGCAGAA-TATCCTCT','GTAGAGGA-TAGATCGC','TAAGGCGA-CTAAGCCT','PB82','PB90','PB27','AGGCAGAA-GTAAGGAG','CGTACTAG-CTAAGCCT','TAAGGCGA-TATCCTCT','PB18','CGTACTAG-AAGGAGTA','GTAGAGGA-AGAGTAGA','PB10','PB34','PB76']
mixing_layer_a = ['CAGAGAGG-TAGATCGC','CAGAGAGG-AGAGTAGA','CAGAGAGG-ACTGCATA','CTCTCTAC-CTAAGCCT','CTCTCTAC-ACTGCATA','PB37','PB_5','CAGAGAGG-TATCCTCT','CTCTCTAC-AGAGTAGA','CAGAGAGG-CTCTCTAT','CTCTCTAC-CTCTCTAT']
mixing_layer_b = ['PB11','CTCTCTAC-TAGATCGC','GGACTCCT-TAGATCGC','GGACTCCT-ACTGCATA','PB77','PB29','PB35','PB45','TCCTGAGC-CTAAGCCT','PB85','CAGAGAGG-CTAAGCCT','GGACTCCT-CTAAGCCT','PB57','PB21']

current_clade = 'mixing_layer_bottom'
coverage = '3'
clade = mixing_layer_b

good_positions = []
# Figure out which positions have SNPs for the clade. Get rid of loci that are purely WT
for p in data_positions:
    tmp = np.array(data.loc[clade, p])[1:]
    if sum(tmp==1) > 0 and sum(np.isnan(tmp)) < (len(tmp)-1)/2.0:
...
mcorr_out_file = '/home/ada/Desktop/PinkBerry_scripts_paper/psb_scripts/recombination_rate/data/srb_clades/mcorr_SRB_data_2024_pipeline_ql_ds_cov_'+ coverage +'_' + current_clade + '.csv'
...
out_file = '/home/ada/Desktop/PinkBerry_scripts_paper/psb_scripts/recombination_rate/data/srb_clades/mcorr_SRB_data_2024_ql_ds_cov_'+ coverage +'_' + current_clade + '.csv'
out = open(out_file, 'w')

data_out_file = '/home/ada/Desktop/PinkBerry_scripts_paper/psb_scripts/recombination_rate/data/srb_clades/mcorr_SRB_raw_data_2024_ql_ds_cov_'+ coverage +'_' + current_clade + '.csv'
...
plt.title('P(l) vs distance SRB (coverage >= ' + coverage + ') \n(' + current_clade + ')')
