...
def make_all_profiles(f_clade_strains, basal_AB_strains, snp_matrix):
    ...
    return([green_prob_matrix, yellow_prob_matrix, white_prob_matrix, missing_prob_matrix])
...
def run_haplotyping(start, length, window_size, strain, contig, snp_matrix, max_penalty, profiles):
    ...
    keep_yellow, keep_green = True, True
    ...
    green_prob_matrix, yellow_prob_matrix, white_prob_matrix, missing_prob_matrix = profiles
...
if __name__ == "__main__":
    ...
    """
    snp_matrix_path = '/home/ada/Desktop/PinkBerry_scripts_paper/data/srb/snp_matrix_data/snp_matrix_fixed_F_middleAB_clade_threshold50_NaNs30wholegenome_fixed_2024.csv'
    f_clade_strains = ['AAGAGGCA-CTAAGCCT', 'AAGAGGCA-TATCCTCT', 'GCTACGCT-ACTGCATA', 'PB39', 'CAGAGAGG-AAGGAGTA', 'CAGAGAGG-GTAAGGAG', 'AAGAGGCA-CTCTCTAT', 'PB87', 'CTCTCTAC-TATCCTCT', 'PB32', 'PB40', 'PB88', 'AAGAGGCA-TAGATCGC', 'PB16', 'PB79', 'PB64', 'AAGAGGCA-GTAAGGAG']
    top_AB = ['TAAGGCGA-ACTGCATA', 'TAAGGCGA-CTCTCTAT', 'AGGCAGAA-TAGATCGC', 'AGGCAGAA-CTCTCTAT', 'PB58', 'TCCTGAGC-ACTGCATA', 'PB83', 'TCCTGAGC-AGAGTAGA', 'PB53', 'PB33', 'PB_4', 'PB84']
    basal_AB_strains = ['GTAGAGGA-TATCCTCT', 'AGGCAGAA-AGAGTAGA', 'PB43', 'TAAGGCGA-AAGGAGTA', 'PB_3', 'CGTACTAG-TAGATCGC', 'TCCTGAGC-TATCCTCT', 'CGTACTAG-ACTGCATA', 'CGTACTAG-CTCTCTAT', 'CGTACTAG-AGAGTAGA']
    mixing_layer_strains = ['CAGAGAGG-TAGATCGC','CAGAGAGG-AGAGTAGA','CAGAGAGG-ACTGCATA','CTCTCTAC-AGAGTAGA','CTCTCTAC-ACTGCATA','CTCTCTAC-CTAAGCCT','PB37','PB_5','PB45','CTCTCTAC-CTCTCTAT','CAGAGAGG-CTCTCTAT','TCCTGAGC-CTAAGCCT','PB85','CAGAGAGG-CTAAGCCT','CTCTCTAC-TAGATCGC','PB11','GGACTCCT-TAGATCGC','GGACTCCT-ACTGCATA','PB77','PB35','PB29','GGACTCCT-CTAAGCCT']
    ...
    profiles = make_all_profiles(f_clade_strains, basal_AB_strains, snp_matrix)
    ...
    per_strain_blocks_green, per_strain_blocks_yellow = {}, {} 
    
    #for strain in strains:
    for strain in mixing_layer_strains:   # testing
        all_contigs_green, all_contigs_yellow = [], []
        for contig, vals in contig_start_stop.items():
            if vals[1] - vals[0] > 100 :
                ...
                wt_regions = get_wt_haplotype_regions(haplotype,columns[contig_start_stop[contig][0]:contig_start_stop[contig][1]])
                print(wt_regions)
