...
plt.bar(ind+width*2, allele_vals_dict_base_10.values(), width, label='frequency <= 10 SNPs / 1kb')
plt.bar(ind+width*3, allele_vals_dict_base_15.values(), width, label='frequency <= 15 SNPs / 1kb')

plt.title('4 allele test values for PSB loci (n=50,000)')
