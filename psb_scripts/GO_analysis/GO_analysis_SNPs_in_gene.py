...
gene_code = ['C0SP86', 'P0A0P0', 'P33919', 'P0A8P8', 'P9WF33', 'P0AEZ3', 'Q8KR08']  # bio processes PSB 10 SNPs or more per 1kb
...
gene_code = ['P60240', 'Q7A801', 'A0A0H2VDN9', 'D0ZRB2']  # genes with 40 - 60 mutations and length between 2 kb - 4 kb
gene_code = ['E0SGL7', 'A1IGV8', 'Q9KIG4', 'G4NYJ6']      # genes with 50 - 80 mutations and length between 3 kb - 8 kb
gene_code = 'rhsC_4'
