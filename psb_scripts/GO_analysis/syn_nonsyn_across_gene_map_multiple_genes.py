...
gene_names = ['rhsC_3', 'hp1', 'hp2', 'hp3', 'hp4', 'hp5', 'hp6', 'hp7', 'hp8']
...
gene_names = ['rhsC_4', 'hp1', 'hp2', 'hp3', 'hp4', 'hp5', 'hp6']
        ...
        for line in f:
            if line.startswith('psb-scaff03'):
                    if str(gene_pos[0]) in line:
                        ...
                        gene_location[gene_names[n]] = [start, end, strand]
